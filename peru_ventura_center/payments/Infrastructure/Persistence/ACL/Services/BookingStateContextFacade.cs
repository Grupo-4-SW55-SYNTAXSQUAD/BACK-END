...
namespace peru_ventura_center.payments.Infrastructure.Persistence.ACL.Services
{
    ...
    {
        public async Task<int> CreateReservationStatus(string state, int booking_states_pk)
        {
            var createReservationStatusCommand = new CreateBookingStateCommand(state, booking_states_pk);
        ...
        public async Task<BookingState?> FetchReservationStatusById(int id)
        {
